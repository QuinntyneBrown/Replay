...
namespace Replay.Api.Controllers
{
    ...
    public class ToDoController
    {
        ...
        [HttpPut("defer", Name = "DeferToDoRoute")]
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [ProducesResponseType(typeof(ProblemDetails), (int)HttpStatusCode.BadRequest)]
        [ProducesResponseType(typeof(DeferToDo.Response), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<DeferToDo.Response>> Defer([FromBody] DeferToDo.Request request)
            => await _mediator.Send(request);

        [HttpPut("complete", Name = "CompleteToDoRoute")]
        [ProducesResponseType((int)HttpStatusCode.InternalServerError)]
        [ProducesResponseType(typeof(ProblemDetails), (int)HttpStatusCode.BadRequest)]
